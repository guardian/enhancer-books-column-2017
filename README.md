...
Adds custom styles to the culture sections "Your books in your words". Use this as a basic template if you need to add custom styles to an article. Simply write your CSS to the main.scss file. 
